		...
		<div class="modal-content">
			...
			<form role="form" method="POST" action="{{ lurl('send-by-email') }}">
				<div class="modal-body">
					...
					@if (count($errors) > 0 and old('sendByEmailForm')=='1')
					...
					<!-- Recipient Email -->
					<div class="form-group required <?php echo ($errors->has('recipient_email')) ? 'has-error' : ''; ?>">
					...
					<input type="hidden" name="ad" value="{{ old('ad') }}">
