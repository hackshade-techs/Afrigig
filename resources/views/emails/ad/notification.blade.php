...
@section('title', trans('mail.ad_notification_title'))
    ...
    <table style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; width: 100%; margin: 0; padding: 0;">
        <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
            <td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0;">@lang('mail.ad_notification_content',
                [
                    'advertiser_name' => mb_ucfirst($ad->seller_name),
                    'title' => $ad->title,
                    'now' => \Carbon\Carbon::now(config('timezone.id'))->formatLocalized('%d %B %Y'),
                    'time' => \Carbon\Carbon::now(config('timezone.id'))->format('H:i'),
                    'countryDomain' => lurl('/'),
