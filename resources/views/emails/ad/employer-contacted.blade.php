...
@section('title', trans('mail.ad_employer_contacted_title', ['title' => $ad->title, 'app_name' => mb_ucfirst(config('settings.app_name'))]))
...
<p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0;">{!! nl2br($msg->message) !!}<br><br>@lang('mail.ad_employer_contacted_content',
    [
        'name' => $msg->name,
        'email' => $msg->email,
        'phone' => $msg->phone,
        'title' => mb_ucfirst($ad->title),
        'urlAd' => lurl(slugify($ad->title).'/'.$ad->id.'.html'),
        'urlAntiScam' => lurl(trans('routes.anti-scam')),
        'countryDomain' => lurl('/'),
