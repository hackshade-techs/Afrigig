    ...
    */
    ...
    'custom' => [
        ...
        'name' => [
            ...
            'min' => 'Le nom doit avoir :min caractères minimum.',
        ...
        'file' => [
            ...
            'max' => 'Le champ :attribute ne doit pas excéder :max.',
        ],
        'filename' => [
            'required' => 'The :attribute field are required.',
            'mimes' => 'The :attribute must in this formats: ' . showValidFileTypes('file') . '.',
            'max' => 'Le champ :attribute ne doit pas excéder :max.',
        ],
        /*
        'pictures.*' => [
            'required' => 'Le champ :attribute est obligatoire.',
            'image' => 'Le champ :attribute doit être au bon formats.',
            'max' => 'Le champ :attribute ne doit pas excéder :max.',
        ],
        */
        'resume' => [
            'required_if' => 'Vous devez ajouter votre CV à l\'annonce.',
            'required' => 'Vous devez ajouter votre CV à l\'annonce.',
            'mimes' => 'Votre CV doit être dans ces formats: ' . showValidFileTypes('file') . '.',
            'max' => 'Le champ :attribute ne doit pas excéder :max.',
        ],
        'logo' => [
