...
class Setting extends BaseModel
{
    ...
    */
    ...
    public function getValueHtml()
    {
        ...
        {
            $out = '<img src="' . Storage::url($this->value) . '" alt="' . $this->value . '" style="width:228px; height:auto;"><br>';
        ...
        {
            $out = '<img src="' . Storage::url($this->value) . '" alt="' . $this->value . '" style="width:32px; height:auto;"><br>';
            $out .= '[<a href="' . url(config('larapen.admin.route_prefix', 'admin').'/setting/' . $this->id . '/edit') . '">Edit</a>]';
    ...
    */
    ...
    public function setValueAttribute($value)
    {
        ...
        else if ($this->attributes['key'] == 'ads_review_activation')
        {
            // If ads review activation enable, then update all current ads
            if ((int)$value == 1) {
                Ad::where('reviewed', '!=', 1)->update(['reviewed' => 1]);
            }
