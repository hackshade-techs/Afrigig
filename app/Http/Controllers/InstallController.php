        ...
        return [
            ...
            [
                ...
                'check' => (file_exists(base_path('/storage')) &&
                    ...
                    // storage/app/
                    (file_exists(base_path('/storage/app')) &&
                    ...
                    // storage/logs/
                    (file_exists(base_path('/storage/logs')) &&
...
';
    ...
    private function updateDatabase($database, $site_info)
    {
        ...
        $mysqli->query($sql);
        $sql = 'UPDATE `' . $database['tables_prefix'] . 'settings` SET `value`="' . $site_info['email'] . '" WHERE `key`="app_email_sender"';
        $mysqli->query($sql);
