-- Geonames.org updates SQL Import for JobClass
-- 
-- Author: BedigitCom
-- http://www.bedigit.com
--
--
-- As you already know, JobClass uses the Geonames databases from:
-- http://download.geonames.org/export/dump/
--
-- Here is the correspondence between the JobClass’s tables and Geonames’s data:
